...
},S=N("//","$"),k=N("/\\*","\\*/"),R=N("#","$");var j=Object.freeze({
...
return t?Number(t):(e=>P.includes(e.toLowerCase()))(e)?0:1}const U={},z=e=>{
console.error(e)},K=(e,...t)=>{console.log("WARN: "+e,...t)},W=(e,t)=>{
U[`${e}/${t}`]||(console.log(`Deprecated as of ${e}. ${t}`),U[`${e}/${t}`]=!0)
},F=Error();function G(e,t,{key:n}){let i=0;const r=e[n],s={},o={}
...
F;G(e,e.begin,{key:"beginScope"}),e.begin=m(e.begin,{joinWith:""})}})(e),(e=>{
...
F;G(e,e.end,{key:"endScope"}),e.end=m(e.end,{joinWith:""})}})(e)}function Z(e){
function t(t,n){
...
;[I,B,X,D].forEach((e=>e(s,o))),e.compilerExtensions.forEach((e=>e(s,o))),
s.__beforeBegin=null,[T,L,C].forEach((e=>e(s,o))),s.isCompiled=!0;let c=null
;return"object"==typeof s.keywords&&s.keywords.$pattern&&(s.keywords=Object.assign({},s.keywords),
c=s.keywords.$pattern,
delete s.keywords.$pattern),c=c||/\w+/,s.keywords&&(s.keywords=H(s.keywords,e.case_insensitive)),
...
const c=Object.create(null);function l(){if(!N.keywords)return void k.addText(R)
;let e=0;N.keywordPatternRe.lastIndex=0;let t=N.keywordPatternRe.exec(R),n=""
;for(;t;){n+=R.substring(e,t.index)
;const r=w.case_insensitive?t[0].toLowerCase():t[0],s=(i=r,N.keywords[i]);if(s){
const[e,i]=s
;if(k.addText(n),n="",c[r]=(c[r]||0)+1,c[r]<=7&&(j+=i),e.startsWith("_"))n+=t[0];else{
const n=w.classNameAliases[e]||e;u(t[0],n)}}else n+=t[0]
;e=N.keywordPatternRe.lastIndex,t=N.keywordPatternRe.exec(R)}var i
;n+=R.substring(e),k.addText(n)}function g(){null!=N.subLanguage?(()=>{
if(""===R)return;let e=null;if("string"==typeof N.subLanguage){
if(!i[N.subLanguage])return void k.addText(R)
;e=E(N.subLanguage,R,!0,S[N.subLanguage]),S[N.subLanguage]=e._top
}else e=_(R,N.subLanguage.length?N.subLanguage:null)
;N.relevance>0&&(j+=e.relevance),k.__addSublanguage(e._emitter,e.language)
})():l(),R=""}function u(e,t){
""!==e&&(k.startScope(t),k.addText(e),k.endScope())}function d(e,t){let n=1
...
const t=e[0],i=n.substring(e.index),r=f(N,e,i);if(!r)return Q;const s=N
;N.endScope&&N.endScope._wrap?(g(),
u(t,N.endScope._wrap)):N.endScope&&N.endScope._multi?(g(),
d(N.endScope,e)):s.skip?R+=t:(s.returnEnd||s.excludeEnd||(R+=t),
g(),s.excludeEnd&&(R=t));do{
N.scope&&k.closeNode(),N.skip||N.subLanguage||(j+=N.relevance),N=N.parent
...
;throw e.mode=N,e}if("end"===s.type){const e=m(s);if(e!==Q)return e}
...
;const M=Z(w);let v="",N=s||M;const S={},k=new p.__emitter(p);(()=>{const e=[]
;for(let t=N;t!==w;t=t.parent)t.scope&&e.unshift(t.scope)
;e.forEach((e=>k.openNode(e)))})();let R="",j=0,A=0,I=0,T=!1;try{
if(w.__emitTokens)w.__emitTokens(n,k);else{for(N.matcher.considerAll();;){
I++,T?T=!1:N.matcher.considerAll(),N.matcher.lastIndex=A
;const e=N.matcher.exec(n);if(!e)break;const t=y(n.substring(A,e.index),e)
;A=e.index+t}y(n.substring(A))}return k.finalize(),v=k.toHTML(),{language:e,
value:v,relevance:j,illegal:!1,_emitter:k,_top:N}}catch(t){
if(t.message&&t.message.includes("Illegal"))return{language:e,value:J(n),
illegal:!0,relevance:0,_illegalBy:{message:t.message,index:A,
context:n.slice(A-100,A+100),mode:t.mode,resultSoFar:v},_emitter:k};if(o)return{
language:e,value:J(n),illegal:!1,relevance:0,errorRaised:t,_emitter:k,_top:N}
...
W("10.7.0","Please use highlightElement now."),x(e)),configure:e=>{p=Y(p,e)},
initHighlighting:()=>{
